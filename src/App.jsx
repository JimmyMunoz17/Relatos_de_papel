...
function AppContent() {
  ...
  const isPublicRoute = ['/login', '/login/register', '/login/forgotpassword'].includes(location.pathname);
  ...
  const PublicRoute = ({ children }) => {
    if (['/login', '/login/register', '/login/forgotpassword'].includes(location.pathname) && user) {
  ...
  return (
    <CartProvider>
      <div className="App">
        ...
        {!(['/login', '/login/register', '/login/forgotpassword'].includes(location.pathname)) && <Header user={user} onLogout={handleLogout} />}
        ...
        {!(['/login', '/login/register', '/login/forgotpassword'].includes(location.pathname)) && <Footer />}
      </div>
    </CartProvider>
  );
}
